...
@NamedQueries({
    ...
    @NamedQuery(name = "Cinemas.findByCreatedAt", query = "SELECT c FROM Cinemas c WHERE c.createdAt = :createdAt")})
public class Cinemas implements Serializable {
    ...
    public Cinemas(Integer id, String name, String location) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "com.tth.pojo.Cinemas[ id=" + id + " ]";
    }
